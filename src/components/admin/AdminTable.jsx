...
export default function AdminTable({ admins, loading, onEdit, onToggle, onDelete }) {
  if (loading) {
    return (
                ...
                <tr key={admin.id} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button
                        onClick={() => !isMainAdmin && onDelete(admin)}
                        ...
                        title={isMainAdmin ? "Main Admin can't be removed" : 'Remove'}
                      >
